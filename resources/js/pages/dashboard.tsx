...
export default function Dashboard() {
    ...
    // @ts-expect-error User is defined in the props
            ...
            <div className="flex h-full flex-1 flex-col gap-4 overflow-x-auto rounded-xl p-4">
                {user && (
                    <div className="flex flex-col">
                        <h2 className="text-2xl font-bold text-lime-500 font-handwriting">hi, {truncate(user.name, 20)}!</h2>
                        <p className="text-sm text-muted-foreground">
                            Here you can find all the tools to help you learn English.
                        </p>
                    </div>
                )}
                ...
                <div className="grid auto-rows-min gap-4 grid-cols-2 md:grid-cols-6">
